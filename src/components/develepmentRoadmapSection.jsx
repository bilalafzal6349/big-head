...
export const DevelopmentRoadMapSection = () => {
  return (
    <div className="text-center  bg-black text-white">
      <Container>
        <h2 className="text-center text-5xl font-signatra p-4 py-24 tracking-tighter">
          Road Map
        </h2>
        <div className="px-8 pb-32">
          ...
          <div className="   lg:grid lg:grid-cols-2 py-24">
            <div className=" pb-16 ">
              <p className="text-sm border-[2px] border-solid border-[#FBFAF5] p-16 text-center mx-auto rounded-xl font-Montserrat font-semibold ">
            ...
            <div className="">
              <p className="border-[2px] border-solid border-[#FBFAF5] p-16 text-center mx-auto rounded-xl text-sm font-Montserrat font-semibold">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Vestibulum tincidunt condimentum dolor, quis sagittis enim
                facilisis a.
              </p>
